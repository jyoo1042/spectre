...
bool FixConservatives::operator()(
  ...
  // Sets the TildeB to zero if its absolute value is below 1e-90.
  // This is to prevent a negative value of tilde_b_squared,
  // which can occur for very low magnetic field leading to wrong
  // arithmetic operations from dealing with small number.
