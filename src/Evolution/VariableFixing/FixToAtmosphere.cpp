...
void FixToAtmosphere<Dim>::apply_magnetization_limit(
  ...
  // // With changes in rest mass density, pressure, and specific internal
  // energy,
  // // specific enthalpy is changed. In order to preserve fluid momentum
  // parallel
  // // to magnetic field, we need to decrease the parallel component of the
  // // spatial velocity. To do this, we follow what's commonly referred to as
  // the
