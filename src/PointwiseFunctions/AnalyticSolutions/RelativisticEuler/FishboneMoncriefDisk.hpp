 ...
 *
 * \warning Originally, we used Kerr-Schild coordinates for the background
 * spacetime metric. Now, we use Spherical-Kerr-Schild
 * coordinates, as defined in gr::Solutions::SphericalKerrSchild.
 * To account for this change, transport velocity originally, computed
 * in Kerr-Schild, is transformed to Spherical-Kerr-Schild coordinates.
 */
