 ...
 * spacetime metric RelativisticEuler::Solutions::FishboneMoncriefDisk.
 * Now, we use Spherical-Kerr-Schild coordinates, as defined in
 * gr::Solutions::SphericalKerrSchild.
 * To account for this change, magnetic field is computed
 * in Kerr-Schild as before, but is transformed to
